...
mixin _$UpdateUserRequest {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, base64Image, bio, userName);

  @override
  String toString() {
    return 'UpdateUserRequest(base64Image: $base64Image, bio: $bio, userName: $userName)';
  }
}
...
abstract mixin class $UpdateUserRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? base64Image, String bio, String userName});
}
...
extension UpdateUserRequestPatterns on UpdateUserRequest {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? base64Image, String bio, String userName)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UpdateUserRequest() when $default != null:
        return $default(_that.base64Image, _that.bio, _that.userName);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String? base64Image, String bio, String userName) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _UpdateUserRequest():
...
/// @nodoc
@JsonSerializable()
class _UpdateUserRequest extends UpdateUserRequest {
  const _UpdateUserRequest(
      {this.base64Image, required this.bio, required this.userName})
      : super._();
