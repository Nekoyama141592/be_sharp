...
abstract class WriteProblem implements _$WriteProblem {
  ...
  const factory WriteProblem({required String question,required dynamic createdAt,required String problemId,@Default([]) List<String> answers,required dynamic updatedAt}) =
      _WriteProblem;
